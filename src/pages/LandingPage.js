...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen">
            ...
            {/* Hero Section */}
            <div className="relative w-full pt-20 pb-8 px-4 overflow-hidden">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start relative">
                        ...
                        <div className="hidden lg:block">
                            <div className="w-full max-w-xs bg-white rounded-xl shadow-lg border border-gray-200 p-4 transform rotate-3 relative lg:left-8">
                        ...
                        <div className="flex justify-center items-center w-full py-4 z-10">
                            <div className="text-center flex flex-col items-center max-w-full px-4">
                                ...
                                <p className="text-gray-600 text-lg sm:text-xl lg:text-2xl mb-8">
                                    Your job search shouldn't be a job.
                                </p>
                                <Link 
                                    to="/signup" 
                                    className="bg-blue-600 text-white px-6 sm:px-8 py-3 rounded-lg hover:bg-blue-700 inline-flex items-center gap-2 text-base sm:text-lg"
                                >
                                    Get Started
                        ...
                        {/* Right Email Card */}
                        <div className="hidden lg:block">
                            <div className="w-full max-w-xs bg-gray-100 rounded-xl shadow-lg border border-gray-200 p-4 transform -rotate-2 relative lg:right-8">
            ...
            <div className="w-full py-12 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-8 justify-items-center items-center">
                        <img src="/images/corplogos/job1.jpeg" alt="Brand" className="h-16 sm:h-20 lg:h-24 w-auto opacity-80" />
                        <img src="/images/corplogos/job6.jpeg" alt="Brand" className="h-16 sm:h-20 lg:h-24 w-auto opacity-80" />
                        <img src="/images/corplogos/job3.jpeg" alt="Brand" className="h-12 sm:h-16 lg:h-20 w-auto opacity-80" />
                        <img src="/images/corplogos/job4.jpeg" alt="Brand" className="h-16 sm:h-20 lg:h-24 w-auto opacity-80" />
                        <img src="/images/corplogos/job7.png" alt="Brand" className="h-16 sm:h-20 lg:h-24 w-auto opacity-80" />
                        <img src="/images/corplogos/job8.png" alt="Brand" className="h-16 sm:h-20 lg:h-24 w-auto opacity-80" />
                        <img src="/images/corplogos/job9.png" alt="Brand" className="h-16 sm:h-20 lg:h-24 w-auto opacity-80" />
                    </div>
                </div>
            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-md">
                            <PencilIcon className="h-10 w-10 sm:h-12 sm:w-12 text-blue-600 mb-4" />
                            <h3 className="text-lg sm:text-xl font-semibold mb-2">Step 1: Fill Out Your Info</h3>
                            <p className="text-gray-600 text-sm sm:text-base">
                                Provide the same details you'd normally include on a job application.
                            </p>
                        </div>
                        <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-md">
                            <AdjustmentsHorizontalIcon className="h-10 w-10 sm:h-12 sm:w-12 text-green-600 mb-4" />
                            <h3 className="text-lg sm:text-xl font-semibold mb-2">Step 2: Choose Preferences</h3>
                            <p className="text-gray-600 text-sm sm:text-base">
                                Select your desired job title, location, salary, and other preferences.
                            </p>
                        </div>
                        <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-md">
                            <ArrowPathIcon className="h-10 w-10 sm:h-12 sm:w-12 text-yellow-600 mb-4" />
                            <h3 className="text-lg sm:text-xl font-semibold mb-2">Step 3: Start Your Search</h3>
                            <p className="text-gray-600 text-sm sm:text-base">
                                We find jobs daily, tailor your resume, and apply for you automatically.
                            </p>
                        </div>
                        <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-md">
                            <BriefcaseIcon className="h-10 w-10 sm:h-12 sm:w-12 text-purple-600 mb-4" />
                            <h3 className="text-lg sm:text-xl font-semibold mb-2">Step 4: Get Hired</h3>
                            <p className="text-gray-600 text-sm sm:text-base">
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    {isStripeLoaded ? (
                        <stripe-pricing-table
                            pricing-table-id="prctbl_1OqXZQKZvJqXZQKZ"
